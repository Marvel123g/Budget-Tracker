...
export const UserProvider = ({ children }) => {
  ...
  const [subscriptionData, setSubscriptionData] = useState(() => {
    const savedSub = localStorage.getItem("sub");
    return savedSub
      ? JSON.parse(savedSub)
      : [
          {
  ...
  const totalLastSevenDaysBalance = lastSevenDaysIncome - lastSevenDaysExpenses;
  ...
  // New helper function
  const setCurrencyValue = (currencySymbol, currencyValue) => {
    if (currencySymbol === "₦") {
